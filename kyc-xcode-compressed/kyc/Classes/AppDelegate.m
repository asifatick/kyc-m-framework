...
//  kyc
//
//  Created by Shawon on 11/12/12.
//  Copyright Core i-Tech 2012. All rights reserved.
//
...
@synthesize invokeString, window, viewController, splashView;
...
{    
    ...
    splashView.view.frame = screenBounds;
    ...
    self.viewController.startPage = @"info-screen.html";
    self.viewController.view.frame = viewBounds;
    // self.viewController.webView.scrollView.scrollEnabled = YES;
...
- (void) webViewDidFinishLoad:(UIWebView*) theWebView 
{
    ...
    [[theWebView scrollView] setShowsVerticalScrollIndicator:NO];
