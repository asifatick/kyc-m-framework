function getQuestions(qno)
{
	...
	},
	{
		...
		"qus" : {
					"index": "6",
					"text" : "When I select an amount of personal possessions coverage with my homeowners policy, this means that:",
					"answers" : [
	...
	},
	{
		...
		"qus" : {
					...
					"answers" : [
									...
									{ "text": "C) Yes, and if the injury is determined to be my fault, I must pay the <i>entire</i> amount myself; liability insurance only covers accidents where no-one is at fault", "isAns" : -1 },						
								],
					"res": 1,
					"RightAnswer": "A",
	...
	},
	{
		...
		"qus" : {
					"index": "1",
					"text" : "If I own a condo or co-op, I am always responsible ONLY for the contents of my home; my building's condo/co-op association covers the building structure and shared spaces.",
					"answers" : [
									{ "text": "True ", "isAns" : -1 },		
									{ "text": "False", "isAns" : 1 },						
								],
					"res": 1,
					"RightAnswer": "False",
					"explanationHead" : "Buildings differ in their rules about which structural parts are the responsibility of the individual unit owner. ",
					"explanation" : "For an explanation of what to watch out for when purchasing condo/co-op insurance, tap the \"Tell Me More\" button below. Otherwise, let's move ahead to the next question.",

					"expForWrongHead" :"There is no standard approach to insuring a condo or co-op. Buildings differ in their rules about which structural parts are the responsibility of the individual unit owner.",
					"expForWrong" :"For an explanation of what to watch out for when purchasing condo/coop insurance, tap the \"Tell Me More\" button below.",

					"AnsDescHead" :"Keep the walls from closing in with condo and co-op insurance",
					"AnsDesc" :  "Know what you're directly responsible for:If you own a condo or co-op, review your documents to understand what's covered by the building's or owners association's \"master policy\"-it should cover shared (common) spaces and facilities (e.g., roof, basement, elevators, boiler, walkways) for both liability and physical damage.<br><br>Be aware that, even inside your unit, buildings differ in their rules about which structural parts are the owner's responsibility. <ul><li>	In some cases, the association is responsible for insuring individual units as they were originally built, including standard fixtures. The individual owner (you), in this case, is only responsible for alterations to the original structure of the apartment, like remodeling the kitchen or replacing a bathtub. <li>	In other cases, however, the condo/co-op association is responsible only for insuring the bare walls, floor and ceiling. You're required to insure kitchen cabinets, built-in appliances, plumbing, wiring, bathroom fixtures etc.</ul>",
					"ansClass" : "tf-center",
				}
	...
	},
	{
		...
		"qus" : {
					"index": "2",
					"text" : "If I rent my home, the landlord insures ONLY the building for damage and liability in the event of a fire, accident, or other disaster.",
					"answers" : [
									{ "text": "A) Yes, I am responsible for covering loss or damage of personal property and liability inside my rental unit ", "isAns" : 1 },		
									{ "text": "B) No, the landlord is responsible for contents and liability for the entire building", "isAns" : -1 },	
									{ "text": "C) No, responsibility for rental unit contents and liability depends on the type of rental (house or apartment)", "isAns" : -1 },						
								],
					"res": 1,
					"RightAnswer": "A",
					"explanationHead" : "You are responsible for covering your rental unit for loss or damage to your belongings and liability.",
					"explanation" : "You're ready to move on to the next question. For more information about renters insurance, tap the \"Tell Me More\" button below.",

					"expForWrongHead" :"You are responsible for covering your rental unit for loss or damage to your belongings and liability.",
					"expForWrong" :"For more information about renters insurance, tap the \"Tell Me More\" button below.",

					"AnsDescHead" :"What you need to know about renters insurance",
					"AnsDesc" :  "If you rent a house or apartment, the general rule is: your stuff, your responsibility.Your landlord's insurance will only cover the costs of repairing the building itself in the event of a fire or other disaster. You need your own coverage, known as renters insurance, to financially protect your household and your belongings against loss, damage and liability. The good news is, because renters insurance covers the value of your belongings, not the physical building, the premium is relatively inexpensive. Renters insurance also includes additional living expense coverage if you are unable to live in your home due to damage from an insured disaster.",
					"ansClass" : "tf-left",
				}
	...
	},
	{
		...
		"qus" : {
					"index": "3",
					"text" : "The Additional Living Expenses (ALE) in my renters/condo/co-op policy pays for the following costs of living away from home while my home is rebuilt:",
					"answers" : [
									{ "text": "A) Hotels/lodging and meals  ", "isAns" : -1 },		
									{ "text": "B) Some personal expenses (e.g., replacement clothing or medications)", "isAns" : -1 },	
									{ "text": "C) Motor vehicle expenses, entertainment and other activities ", "isAns" : -1 },	
					...
					"res": 1,
					"RightAnswer": "D",
					"explanationHead" : "ALE covers costs of lodging and food while displaced from your home, plus other additional expenses as specified by your policy.",
					"explanation" : "For information about ALE provisions, tap the \"Tell Me More\" button below. Otherwise, let's move ahead to the next question.",

					"expForWrongHead" :"ALE covers costs of lodging and food while you are displaced from your home, plus other additional living expenses as specified by your policy.",
					"expForWrong" :"For information about ALE provisions, tap the \"Tell Me More\" button below.",
	...
	},
	{
		...
		"qus" : {
					"index": "4",
					"text" : "If a guest slips and breaks their leg on my staircase, then sues me, I'm covered no matter what the cost.",
					"answers" : [
									{ "text": "True ", "isAns" : -1 },		
									{ "text": "False", "isAns" : 1 },	
								],
					...
					"RightAnswer": "False",
					"explanationHead" : "The amount of personal liability coverage you need depends on several factors, including your personal net worth.",
					"explanation" : "For an explanation of what's covered by the liability portion of yourrenters, condo or co-oppolicy, tap the \"Tell Me More\" button below.",

					"expForWrongHead" :"Your personal liability for property damage or bodily injury to others can vary with the number and type of risk factors and your financial status.",
					"expForWrong" :"Tap the \"Tell Me More\" button below for an explanation of what's covered by the liability portion of yourrenters, condo or co-op policy.",

					"AnsDescHead" :"Your home, your responsibility: Understand your risk factors",
					"AnsDesc" :  "Standard renters, condo and co-op policies include liability insurance, which covers your household against lawsuits for bodily injury or property damage caused by you, your family members, or even your pets, as well as injuries someone accidentally incurs on your property. The coverage you need depends on what you have to lose: persons with more financial assets can require more coverage against legal costs and court awards. An Insurance Professional can help you determine the amount of coverage that worksbest for your situation.",
					"ansClass" : "tf-center",
				}
	...
	},
	{
		...
		"qus" : {
					...
					"text" : "If a visitor is injured while in my home, they must first sue me in order to be compensated for medical treatment.",
					"answers" : [
									{ "text": "A) No, renters, condo and co-op policies provide no-fault medical coverage up to pay directly for medical expenses ", "isAns" : 1 },		
									{ "text": "B) Yes, and even if the injury is determined to be my fault, my liability insurance will pay any court-ordered settlement in full", "isAns" : -1 },	
					...
					"res": 1,
					"RightAnswer": "A",
					"explanationHead" : "Renters, condo and co-op policies include no-fault medical coverage for injuries that occur in your home.",
					"explanation" : "You're ready to move on to the next question. For more information about how medical expenses are covered, tap the \"Tell Me More\" button below.",
	...
	},
	{
		...
		"qus" : {
					"index": "6",
					"text" : "Yes or no: I can purchase additional insurance in case court awards exceed the maximum level of liability coverage in my renters, condo and co-op policy.",
					"answers" : [
									{ "text": "A) Yes, there is a type of insurance that offers expanded coverage-and for a broader range of liability types ", "isAns" : 1 },		
									{ "text": "B) Yes, I can purchase expanded coverage, but only to cover plaintiffs' bodily injuries", "isAns" : -1 },	
									{ "text": "C) No, the party suing me must accept whatever my insurer is willing to pay", "isAns" : -1 },		
					...
					"res": 1,
					"RightAnswer": "A",
					"explanationHead" : "Additional insurance-an \"Umbrella\" policy-is available to pay legal settlements in excess of what's covered by your renters, condo and co-op policy.",
					"explanation" : "Tap the \"Tell Me More\" button below for information about this type of policy.",

					"expForWrongHead" :"Additional insurance-an \"Umbrella\" policy-is available to pay legal settlements in excess of what's covered by your renters, condo and co-op policy, while covering you for broader types of liability.",
					"expForWrong" :"Tap the \"Tell Me More\" button below to learn more about this type of policy.",

					"AnsDescHead" :"Consider Umbrella coverage for a rainy day...",
					"AnsDesc" :  "The more you've got, the more you've got to lose. In our litigious society, personal liability coverage, whether through standard homeowners policies or through your auto insurance, may not offer adequate protection against the unknown.\"Umbrella\" coverage provides an extra layer of liability protection. The coverage can go up to $10 million, and covers broad types of liability, including libel and slander.<br><br>Because Umbrella coverage is supplemental, it kicks in when you reach the limit on the underlying personal liability coverage in your other insurance policies (e.g., auto).But once you've satisfied that requirement, Umbrella coverage is a highly cost-effective way to protect yourself, your family and your hard-earned assets. Talk to your Insurance Professional to develop the best strategy for dealing with potential liability issues.",
					"ansClass" : "tf-left",
				}
	...
	},
	{
		...
		"qus" : {
					...
					"AnsDescHead" :"Premium advice: Simple ways to reduce the cost of insurance",
					"AnsDesc" :  "To encourage safety and help customers save money, insurers may offer discounts for:<ul><li>	Installation of smoke detectors and burglar alarm/security systems<li>	Upgrades to plumbing or electrical systems that meet modern safety code standards <li>	Measures to make your home safer (i.e. adding storm shutters and shatter-proof glass, reinforcing your roof to make your home more resistant to windstorms, etc)<li>	Age: If you are at least 55 years old and retired, for instance, you may qualify for a discount of up to 10% at some companies<li>	Multiple policies-home, life, auto, etc-with the same company<li>	Long-time customer loyalty<li>	Good credit</ul><br><br>Talk to an Insurance Professional to see what's available, and how a little bit of planning can result in substantial savings.",
					"ansClass" : "tf-center",
				}
